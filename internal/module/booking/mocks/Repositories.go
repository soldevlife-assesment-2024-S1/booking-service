...
// CountPendingPaymentByTicketID provides a mock function with given fields: ctx, ticketID
func (_m *Repositories) CountPendingPaymentByTicketID(ctx context.Context, ticketID int64) (int64, error) {
